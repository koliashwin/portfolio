...
import { Add, DocumentScanner, Email, GitHub, Phone, WhatsApp } from "@mui/icons-material";
    ...
    return (
        <>
            ...
            <Grid container spacing={2} justifyContent={"center"}>
                <Grid item md={4} sx={{ display: { xs: "none", sm: "none", md: "flex" }}}>
                ...
                <Grid item sm={12} md={5}>
                    ...
                    {/* <form onSubmit={handleSubmit}> 
                        <TextField
                            ...
                            sx={{ mx: 2, my: 1, width: { xs: "70vw", lg: "30vw" } }}
                        />
                        <TextField
                            id="sub-input"
                            name="sub"
                        ...
                        <TextField
                            ...
                            onChange={handleInputChange}
                            multiline
                            sx={{ mx: 2, my: 1, width: { xs: "70vw", lg: "50vw" }}}
                        />
                        <br/>
                        <Button type="submit" variant="contained" color="primary" sx={{mx: 2, my: 1,}}>
                            Send
                        </Button>
                    </form> */}
                    {/* <Divider>
                    ...
                    <Box display={"flex"} justifyContent={"center"}  my={1} sx={{ '& > :not(style)': { m: 1 } }}>
                        ...
                        <Fab color="primary" aria-label="Github" size="small" href="mailto: ashwinkoli02@gmail.com">
                            <Email/>
                        </Fab>
                        <Fab color="primary" aria-label="Github" size="small" href="https://wa.me/9594694362">
                            <WhatsApp/>
                        </Fab>
                        <Fab color="primary" aria-label="Github" size="small" href="tel:8356979743">
                            <Phone/>
                        </Fab>
                        <Fab color="primary" aria-label="Github" size="small" href="https://drive.google.com/file/d/1SYLzWCSQDfkW2_PIk75Hz75_u1H7C3_H/view?usp=sharing">
                            <DocumentScanner/>
                        </Fab>
                    </Box>
                </Grid>
